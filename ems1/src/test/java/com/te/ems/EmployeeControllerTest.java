...
public class EmployeeControllerTest {
	...
	public void add() throws Exception {
		...
		EmployeeDto build2 = EmployeeDto.builder().age(25).lastName("Amit").firstName("wawale").build();
	...
	public void findall() throws UnsupportedEncodingException, Exception {
		List<Employee> asList = Arrays.asList(
				Employee.builder().age(20).id(1).lastName("mandal").firstName("amit").build(),
				Employee.builder().age(20).id(1).lastName("mandal").firstName("amit").build());
	...
	public void delete() throws JsonProcessingException {
		Employee build = Employee.builder().age(20).id(1).lastName("mandal").firstName("amit").build();
		String writeValueAsString = objectMapper.writeValueAsString(build);
	...
	public void update() throws UnsupportedEncodingException, Exception {
		Employee build = Employee.builder().age(20).id(1).lastName("mandal").firstName("amit").build();
		EmployeeDto build2 = EmployeeDto.builder().age(20).lastName("mandal").firstName("amit").build();
		String writeValueAsString = objectMapper.writeValueAsString(build);
